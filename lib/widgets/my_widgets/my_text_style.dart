...
final style15SemiBoldBlack = GoogleFonts.poppins(
  fontSize: 15,
  fontWeight: FontWeight.w500,
  color: colorBlack,
);
final style15SemiBoldRed = GoogleFonts.poppins(
  fontSize: 15,
  fontWeight: FontWeight.w600,
  color: kPrimaryGreen,
);
final style15RegularBlack = GoogleFonts.poppins(
  fontSize: 15,
...
class MyTextStyle {
  ...
  static TextStyle getStyle(
    ...
    Color finalColor = color ?? colorWhite;
    finalColor = xMuted
  ...
  static TextStyle bodySmall(
    ...
    return getStyle(
        ...
        fontWeight: fontWeight ?? _defaultTextFontWeight[MyTextType.bodySmall],
        decoration: decoration,
        textStyle: textStyle,
        wordSpacing: wordSpacing,
        xMuted: xMuted);
