...
import '../../../widgets/my_widgets/my.dart';
import '../../../widgets/my_widgets/my_constant.dart';
import '../../../widgets/my_widgets/my_text_style.dart';
...
class AppStyle {
  ...
  static void initMyStyle() {
    ...
    My.setConstant(MyConstantData(
      ...
      //     MyBreadcrumbItem(name: 'Doopos', route: '/dashboard'),
    ));
    bool isMobile = true;
    try {
...
class AppColors {
  static final Color star = const Color(0xffFFC233);
