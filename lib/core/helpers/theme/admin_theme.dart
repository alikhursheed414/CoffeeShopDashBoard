...
* Version : 1.0.0
* */
import 'package:coffee_shop_dashboard/core/helpers/theme/theme_customizer.dart';
...
class LeftBarTheme {
  ...
  LeftBarTheme({
    ...
    this.activeItemBackground = const Color(0xffED2E39),
...
class ContentTheme {
  ...
  final Color cardBackground, cardShadow, cardBorder, cardText, lightGrey;
  ...
  ContentTheme({
    ...
    this.primary = const Color(0xffED2E39),
    // this.primary = const Color(0xff006784),
    this.onPrimary = const Color(0xffffffff),
    this.disabled = const Color(0xffffffff),
    this.onDisabled = const Color(0xffffffff),
    this.secondary = const Color(0xffFFBC0D),
    ...
    this.warning = const Color(0xffFFBC0D),
    ...
    this.lightGrey = const Color(0xff98a6ad),
  ...
  static final ContentTheme lightContentTheme = ContentTheme(
    ...
    lightGrey: const Color(0xff98a6ad),
  );
